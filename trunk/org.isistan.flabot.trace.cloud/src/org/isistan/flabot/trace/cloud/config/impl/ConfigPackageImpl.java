...
public class ConfigPackageImpl extends EPackageImpl implements ConfigPackage {
	 ...
	 * @see org.isistan.flabot.trace.cloud.config.file.config.ConfigPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEAttribute(getCloudLogPersister_FileName(), ecorePackage.getEString(), "fileName", "traceOutput.tracelog", 0, 1, CloudLogPersister.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
